		...
		<div class="row">
			...
			<div class="col-md-4">
				...
				<div class="register anim fadeInUp" data-wow-delay="2s">
					...
					<a href='/booking/'><button class="but-tn">записаться онлайн</button></a>
				</div>
<!--				<a href="/akcii-i-skidki/" class="action-link">акции и скидки ></a>-->
	...
	<div class="container-fluid main center">
		<div class="row center-top">
			...
			<div class="col-md-4">
				<div class="dct">
					<h5>Портфолио</h5>
					<a href="/category/portfolio/" class="but-tn">подробнее</a>
				</div>
				<a href="/category/portfolio/" class="full-box"></a>
			</div>
			<div class="col-md-4">
				<div class="dct">
					<h5>Услуги и цены</h5>
    ...
    <section class="first">
        <div class="row center-bottom" style="margin: 0 auto 24px;">
	...
	<section class="third">
		...
		<div class="row">
			...
			<?php foreach ($posts as $post) : ?>
                    <div class="article">
                        <a href="<?php the_permalink(); ?>" style="background: url('<?php echo get_the_post_thumbnail_url(); ?>') center no-repeat; background-size:cover;">
...
ROW;
        ...
        <div class="but-block">
            ...
            if (!get_page_by_path('feedback')){
                ...
                echo '<a href="/feedback/" class="but-tn">больше</a>';
                echo '<a href="/feedback/#send_form" class="but-tn">добавить</a>';
            }
            ?>
        </div>
    </section> <!-- reviews -->
